...
1. **Ensures Docker is running** - Verifies the Docker daemon is available; kills orphaned NanoClaw containers from previous runs
...
| "Claude Code process exited with code 1" | Docker not running | Check logs; ensure Docker daemon is started |
